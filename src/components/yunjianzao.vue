...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      initVideo () {
        this.getPubKey(() =>{
          let appkey = "28794018";                                  //综合安防管理平台提供的appkey，必填
          let secret = this.setEncrypt("nNibIIgRf1gUXcUP74h1");   //综合安防管理平台提供的secret，必填
          let ip = "223.94.51.37";                              //综合安防管理平台IP地址，必填
          let port = 449;                                     //综合安防管理平台端口，若启用HTTPS协议，默认443
