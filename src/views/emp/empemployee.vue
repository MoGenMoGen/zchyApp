  ...
  <basic-container>
    ...
    <avue-crud :option="option"
      ...
      <template slot="state" slot-scope="scope">
        <el-tag v-if="scope.row.state === 1 " type="success">在职</el-tag>
        <el-tag v-if="scope.row.state === 2 " type="warning">离职</el-tag>
      ...
      option: {
        ...
        column: [
          ...
          },
          {
            ...
            rules: [{
              required: false,
              message: "请输入员工状态(1.在职,2.离职,3.待定,4.已过期)",
              trigger: "blur"
            }]
          },
          {
  ...
  methods: {
   ...
   handleExport() {
      this.$confirm("是否导出用户数据?", "提示", {
        ...
        window.open(`/api/blade-emp/empemployee/export?types=1&${this.website.tokenHeader}=${getToken()}&ids=` + this.ids);
      }).then(() => {
