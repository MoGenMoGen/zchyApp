<template>
  <el-dialog :title="dialogTitle" width="1200px" :visible.sync="visible"
             append-to-body>
    <basic-container>
...
<script>
  import {add, getDetail} from "@/api/face/face";
  ...
  export default {
    ...
    methods: {
      init (row, groupId, faceUserId) {
        this.form = {};
        this.imgUrl = '';
        this.picture = false;
        this.isVideo = false;
        this.visible = true;
        this.form.creamType = 1;
        this.form.groupId = groupId;
        this.form.faceUserId = faceUserId;
        if (row) {
          this.dialogTitle = '修改';
