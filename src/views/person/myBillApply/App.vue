<template>
	<div id="container">
		<van-popup v-model="showPicker" round position="bottom">
		  <van-picker show-toolbar :columns="invoiceType" value-key="nm" @cancel="showPicker = false" @confirm="onConfirm"/>
		</van-popup>
		<van-popup v-model="showPicker2" round position="bottom">
		  <van-picker show-toolbar :columns="headUpType" value-key="label" @cancel="showPicker2 = false" @confirm="onConfirm2"/>
		</van-popup>
		...
		<div class="body">
			<div class="info-box">
				...
				<van-row class="row" align="center" type="flex">
				    ...
				    <van-col span="7"><p class="row-label">订单编号：</p></van-col>
				    <van-col span="15" offset="1"><p class="row-label">{{orderCd}}</p></van-col>
				</van-row>
				<van-row class="row" align="center" type="flex">
					<van-col span="1" style="color:#FF2015;">*</van-col>
				    <van-col span="7"><p class="row-label">发票类型：</p></van-col>
				    <van-col span="15" offset="1" style="display: flex;align-items: center;justify-content: space-between;">
						<p @click="showPicker=true" style="flex:1"><span v-if="invoice">{{invoice}}</span><span v-else>请选择</span></p> <van-icon name="arrow" />
					</van-col>
				</van-row>
				<van-row class="row" align="center" type="flex">
					<van-col span="1" style="color:#FF2015;">*</van-col>
				    <van-col span="7"><p class="row-label">抬头类型：</p></van-col>
				    <van-col span="15" offset="1" style="display: flex;align-items: center;justify-content: space-between;">
						<p @click="showPicker2=true" style="flex:1"><span v-if="headUp">{{headUp}}</span><span v-else>请选择</span></p> <van-icon name="arrow" />
					</van-col>
				</van-row>
				<van-row class="row" align="center" type="flex" v-if="headUp!='个人'">
					<van-col span="1" style="color:#FF2015;">*</van-col>
				    <van-col span="7"><p class="row-label">单位名称：</p></van-col>
				    <van-col span="15" offset="1"><input placeholder="输入单位名称" v-model="buyerName"></van-col>
				</van-row>
				<van-row class="row" align="center" type="flex" v-if="headUp=='个人'">
					<van-col span="1" style="color:#FF2015;">*</van-col>
				    <van-col span="7"><p class="row-label">发票抬头：</p></van-col>
				    <van-col span="15" offset="1"><input v-model="buyerName"></van-col>
				</van-row>
				<van-row class="row" align="center" type="flex" v-if="headUp!='个人'">
					<van-col span="1"></van-col>
				    <van-col span="7"><p class="row-label">发票税号：</p></van-col>
				    <van-col span="15" offset="1"><input placeholder="输入发票税号" v-model="buyerTaxNum"></van-col>
				</van-row>
				<van-row class="row" align="center" type="flex">
					<van-col span="1"></van-col>
				    <van-col span="7"><p class="row-label">备注：</p></van-col>
			...
			<div class="info-box" v-if="headUp!='个人'">
				...
				<van-row class="row" align="center" type="flex">
					<van-col span="1" style="color:#FF2015;">*</van-col>
				    <van-col span="7"><p class="row-label">注册地址：</p></van-col>
				    <van-col span="15" offset="1"><input placeholder="输入注册地址" v-model="buyerAddress"></van-col>
				</van-row>
				<van-row class="row" align="center" type="flex">
					<van-col span="1" style="color:#FF2015;">*</van-col>
				    <van-col span="7"><p class="row-label">注册电话：</p></van-col>
				    <van-col span="15" offset="1"><input placeholder="输入注册电话" v-model="buyerTel"></van-col>
				</van-row>
				<van-row class="row" align="center" type="flex">
					<van-col span="1" style="color:#FF2015;">*</van-col>
				    <van-col span="7"><p class="row-label">开户银行：</p></van-col>
				    <van-col span="15" offset="1"><input placeholder="输入开户银行" v-model="bank"></van-col>
				</van-row>
				<van-row class="row" align="center" type="flex">
					<van-col span="1" style="color:#FF2015;">*</van-col>
				    <van-col span="7"><p class="row-label">银行账户：</p></van-col>
			...
			<div class="info-box" v-if="headUp!='个人'">
				...
				<van-row class="row" align="center" type="flex">
					<van-col span="1" style="color:#FF2015;">*</van-col>
				    <van-col span="7"><p class="row-label">收票人地址：</p></van-col>
				    <van-col span="15" offset="1"><input placeholder="输入收票人地址" v-model="address"></van-col>
				</van-row>
				<van-row class="row" align="center" type="flex">
					<van-col span="1" style="color:#FF2015;">*</van-col>
				    <van-col span="7"><p class="row-label">收票人邮箱：</p></van-col>
