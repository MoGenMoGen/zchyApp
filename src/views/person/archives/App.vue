    ...
    <div id="container">
        ...
        <div class="body">
            <div class="list-cont">
                ...
                <div class="line2" v-if="!showWeiBao">
		...
		methods: {
			...
			changeDevice(){
				...
				if(isPC){
					...
					if(this.from==2){
						window.location.href = window.location.origin+this.serverAddr+'/personal/shipFileDetail?cdType=2&formW=design&id='+this.id
					}else if(this.buildW==2){
					    window.location.href = window.location.origin+this.serverAddr+'/personal/shipFileDetail?cdType=3&formW=build&id='+this.id
					}else{
						window.location.href = window.location.origin+this.serverAddr+'/personal/archives?id='+this.id
					}
