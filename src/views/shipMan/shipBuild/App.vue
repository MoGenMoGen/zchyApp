<template>
    <div class="app">
			<van-nav-bar fixed title="船舶建造" :border="false" class="fixTop">
...
<script>
  ...
  import bgS from '@/assets/img/bgS.png'
	import build1 from '@/assets/img/shipMan/diy报价.png'
	import build2 from '@/assets/img/shipMan/建造规范.png'
	import build3 from '@/assets/img/shipMan/建造船厂.png'
	import buildStep from '@/assets/img/shipMan/建造流程.png'
  ...
  export default {
		...
		methods: {
			...
			changeDevice(){
				...
				if(isPC){
					window.location.href = window.location.origin+this.serverAddr+'/shipDisplay/shipBuild'
				}
			},
			async getAdert(){
