    ...
    <div class="upload">
      <el-form :inline="true">
        <el-row :gutter="24">
          <el-col :span="2">
            <el-form-item>
              <div class="filebox" v-if="this.buttonShow">
          ...
          <el-col :span="8">
            <el-form-item>
              ...
              <el-progress :text-inside="true" :stroke-width="16" :percentage=authProgress :status='authProgress == 100 ? "success":"warning"'></el-progress>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item>
        ...
        let uploader = new AliyunUpload.Vod({
          ...
          onUploadstarted: function (uploadInfo) {
            ...
            if (!uploadInfo.videoId) {
              ...
              // self.$http.get('/general/vod/createUploadVideo', {
                ...
                console.log('onUploadstarted: videoId:' + videoId)
                // self.$emit('my-event', videoId)
          ...
          onUploadSucceed: function (uploadInfo) {
            ...
            self.$emit('my-event', uploadInfo.videoId)
          ...
          onUploadEnd: function (uploadInfo) {
            ...
            // self.$emit('my-event', this.videoId)
