<template>
    <div class="app" >
        <van-nav-bar  title="文献资料详情" :border="false" class="fixTop" style="background-color: #2778BE;">
    ...
    export default {
		...
		methods: {
			...
			changeDevice(){
				...
				if(isPC){
					window.location.href = window.location.origin+this.serverAddr+'/learning/infoDetail?id='+this.id
				}
			},
            back(){
                window.history.go(-1);
