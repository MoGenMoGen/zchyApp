...
<!--            <img src="https://img.shields.io/badge/Spring%20Cloud-Greenwich.SR6-blue.svg" alt="Coverage Status"/>-->
            ...
            <a target="_blank" href="http://julian.jinkworld.com">
              <img src="https://img.shields.io/badge/Develop%20Author-%20PengJun-blue.svg" alt="Downloads"/>
            </a>
            <a target="_blank" href="http://julian.jinkworld.com">
              <img src="https://img.shields.io/badge/Copyright%20-@Jlink-%23ff3f59.svg" alt="Downloads"/>
            </a>
          </p>
        </basic-container>
      </el-col>
    ...
    <el-row>
      <el-col :span="18">
        <basic-container>
<!--          //博汇-->
<!--          <iframe src="http://visual.longxinchem.cn/view/1366314653600223234" width="1152" height="648"></iframe>-->
        </basic-container>
      </el-col>
      <el-col :span="6">
        <el-row>
          <basic-container>
            <div class="el-font-size">
              ...
              <span><el-tag>宁波博汇化工管理平台</el-tag></span>
<!--              <span><el-tag>宁波德欣科技管理平台</el-tag></span>-->
              <br/>
<!--              <span>数据大屏</span>-->
              <el-divider direction="vertical"/>
<!--              //博汇-->
<!--              <span><el-link href="http://10.10.2.20:81/view/1366314653600223234" target="_blank"-->
<!--                             type="primary">http://10.10.2.20:81/view/1366...</el-link></span>-->
              <el-divider content-position="right"><i class="el-icon-star-off"/></el-divider>
              <span>技术支持</span>
              <el-divider direction="vertical"/>
              <span><el-tag>浙工大智慧应急管理研究中心</el-tag></span>
              <br/>
              <span>copyright</span>
              <el-divider direction="vertical"/>
              <span><el-tag>广知科技</el-tag></span>
<!--              <el-divider direction="vertical"/>-->
...
<!--              <el-collapse-item title="2.0.1.RELEASE发布,新增访客模块,员工管理模块" name="17">-->
<!--                <div>1.升级 Avue 至 2.6.15</div>-->
<!--                <div>2.升级 SpringBoot 至 2.1.16.RELEASE</div>-->
<!--                <div>3.新增访客模块</div>-->
<!--                <div>4.项目集成UReport2报表管理模块</div>-->
<!--                <div>5.员工管理模块</div>-->
<!--                <div>6.后端界面进行优化</div>-->
<!--              </el-collapse-item>-->
<!--            </el-collapse>-->
